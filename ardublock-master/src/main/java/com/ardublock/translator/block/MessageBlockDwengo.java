...
public class MessageBlockDwengo extends TranslatorBlock
{
	public MessageBlockDwengo(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
